defmodule ObscuraWeb.PostLiveTest do
  use ObscuraWeb.ConnCase

  import Phoenix.LiveViewTest
  import Obscura.CMSFixtures

  @create_attrs %{description: "some description", title: "some title", content: "some content", publish_at: "2025-05-03T18:00:00"}
  @update_attrs %{description: "some updated description", title: "some updated title", content: "some updated content", publish_at: "2025-05-04T18:00:00"}
